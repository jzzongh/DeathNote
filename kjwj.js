...
class UserInfo {
    ...
    async login() {
        ...
        let url = `https://www.kejiwanjia.net/wp-json/jwt-auth/v1/token`
    ...
    async getUserMission() {
        let url = `https://www.kejiwanjia.net/wp-json/b2/v1/getUserMission`
    ...
    async doSign() {
        let url = `https://www.kejiwanjia.net/wp-json/b2/v1/userMission`
        let body = ``
        let urlObject = populateUrlObject(url,this.token,body)
        await httpRequest('post',urlObject)
        let result = httpResult;
